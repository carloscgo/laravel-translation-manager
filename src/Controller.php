<?php 
namespace CarlosCGO\TranslationManager;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller as BaseController;
use CarlosCGO\TranslationManager\Models\Translation;
use Illuminate\Support\Collection;

class Controller extends BaseController
{
    /** @var \CarlosCGO\TranslationManager\Manager  */
    protected $manager;
    ...
    public function getIndex($group = null)
    {
        ...
        foreach($allTranslations as $translation){
         ...
         return view('translation-manager::index')
            ...
            ->with('editUrl', action('\CarlosCGO\TranslationManager\Controller@postEdit', [$group]))
    ...
    public function postAddGroup(Request $request)
    {
        ...
        if ($group)
        {
            return redirect()->action('\CarlosCGO\TranslationManager\Controller@getView',$group);
        }
        else
        {
            return redirect()->back();
